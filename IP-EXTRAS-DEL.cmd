...
:MAIN
	...
	netsh interface ip delete address "LAN1$temp" 192.168.0.8
	netsh interface ip delete address "LAN1$temp" 192.168.1.8
	netsh interface ip delete address "LAN1$temp" 192.168.10.8
	netsh interface ip delete address "LAN1$temp" 192.168.168.8
	netsh interface ip delete address "LAN1$temp" 192.168.168.192
